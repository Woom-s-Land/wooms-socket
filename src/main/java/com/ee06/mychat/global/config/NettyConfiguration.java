...
import com.ee06.mychat.netty.handler.ChatChannelInitializer;
...
public class NettyConfiguration {
    ...
    public ServerBootstrap bootstrap(ChatChannelInitializer chatChannelInitializer) {
        ...
        log.info("port {} ", nettyProperties.getTcpPort());
